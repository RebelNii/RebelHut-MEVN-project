  ...
  actions: {
    ...
    async regUser({ commit }, { username, password, roles }) {
      const res = await axios.post(
        "https://rebelhut-api.onrender.com/users",
    ...
    async deleteUser({ commit }, id) {
      const res = await axios.delete(
        `https://rebelhut-api.onrender.com/users/${id}`,
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
          },
    ...
    async loginUser({ commit }, { username, password }) {
      const { data } = await axios.post(
        "https://rebelhut-api.onrender.com/auth",
        { username, password },
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
    ...
    async logout({ commit }) {
      const { data } = await axios.post(
        "https://rebelhut-api.onrender.com/auth/logout"
      );
    ...
    async addNote({ commit }, { user, title, text }) {
      const res = await axios.post(
        "https://rebelhut-api.onrender.com/notes",
        { user, title, text },
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
    ...
    async deleteNote({ commit }, id) {
      const { data } = await axios.delete(
        `https://rebelhut-api.onrender.com/notes/${id}`,
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
          },
